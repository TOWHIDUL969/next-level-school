...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // এখানে পরে তোমার registration logic বসাবে।
  ...
  return (
    ...
    >
      ...
      <header className="register-brand relative z-20 flex items-center justify-between px-6 py-6 sm:px-10 lg:px-14">
        ...
        >
          <div className="flex h-11 w-11 items-center justify-center font-black tracking-tight rounded-full shadow-[0_0_30px_rgba(255,255,255,0.05)] transition duration-300 group-hover:border-white/30 group-hover:bg-white/10">
